...
import { TypeScriptDay1 } from "./pages/TypeScriptDay1";

import  TypeScriptDayT from "./pages/TypeScriptDayT.tsx";
import { TypeScriptDay2 } from "./pages/TypeScriptDay2";




import Day2StateSample from "./pages/Day2StateSample";
import { Day2functional } from "./pages/Day2functional";
  ...
  alignItems: "center"}}>
       <Link to="/">
        ...
        <div style={{display:"flex", marginTop: 20}}>
          <Link to="/typescript1"><div style={{width:160, marginTop: 10, color: 
          ...
          <Link to="/typescript2"><div style={{width:160, marginTop: 10, color: 
          color, textAlign:"center", fontSize:13, cursor:"pointer", fontFamily:"Mark Pro Heavy", letterSpacing:5}}
            onClick={()=>{
              //console.log("day1");
              //this.props.history.push("/day1")
...
class App extends Component {
  ...
  render() {
    ...
    return <Router>
       ...
       <Route path="/typescript1" 
                  element={<TypeScriptDay1/>} 
                 />  
          <Route path="/typescript1_t" 
          element={<TypeScriptDayT/>} 
          />  
        <Route path="/typescript2" 
        element={<TypeScriptDay2/>} 
        />  
       <Route path="/day1" 
                  element={<Day1/>} 
                 />  
                 ...
                 />  
                    <Route exact path="/day2functional" 
                  element={<Day2functional/>} 
                 />  
